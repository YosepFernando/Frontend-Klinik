        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Buat Lowongan Kerja Baru</h4>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('recruitments.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="slots" class="form-label">Jumlah Lowongan <span class="text-danger">*</span></label>
                                    <input type="number" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                        <option value="open" {{ old('status', 'open') == 'open' ? 'selected' : '' }}>Buka</option>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('recruitments.index') }}" class="btn btn-secondary me-md-2">Batal</a>
