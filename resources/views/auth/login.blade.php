                ...
                <div class="auth-card m-10 w-100 ">
                    <div class="auth-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" id="loginForm">
                            ...
                            <div class="form-check d-flex" style="align-items: center; gap: 8px;">
            ...
            <div class="col-12 w-50">
                <div class="auth-card w-100 m-0 h-100">
                    <div class="auth-body background h-100 d-flex flex-wrap">
                        {{-- <img class="img-fluid" style="border-radius: 0.9rem;" src="{{ asset("images/nesh.jpeg") }}" alt="Auth Image"> --}}
                        <div class="text-auth" style="height: 0">
                            <h1 style="background: rgba(50, 48, 48, 0.3); border-radius: 0.9rem; padding: 0.5rem 1rem; backdrop-filter: blur(5px); /* efek kaca */ -webkit-backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.3); color: #fff; /* teks putih biar kontras */"><b>Masuk</b></h1>
                        </div>
                        <div class="text-auth">
                            <h1><b>Hallo!</b> <br>Selamat Datang Kembali!</h1>
                        </div>
                    </div>
                </div>
            </div>
