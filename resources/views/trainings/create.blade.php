    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-graduation-cap me-2"></i>Tambah Pelatihan</h2>
                    ...
                    <form action="{{ route('trainings.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('jenis_pelatihan') is-invalid @enderror" 
                                        ...
                                        <option value="video" {{ old('jenis_pelatihan') == 'video' ? 'selected' : '' }}>Video Online</option>
                                        <option value="document" {{ old('jenis_pelatihan') == 'document' ? 'selected' : '' }}>Dokumen</option>
                                        <option value="offline" {{ old('jenis_pelatihan') == 'offline' ? 'selected' : '' }}>Offline/Tatap Muka</option>
                                    </select>
                        ...
                        <div class="mb-3" id="location_field" style="display: none;">
                            ...
                            <textarea class="form-control @error('konten') is-invalid @enderror" 
                                      id="konten" name="konten" rows="3">{{ old('konten') }}</textarea>
                            @error('konten')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Masukkan alamat lengkap lokasi pelatihan</div>
                        </div>
