    ...
    public function update(Request $request, $id)
{
    ...
    {
        try {
            $userId = isset($lamaranData['id_user']) ? (int)$lamaranData['id_user'] : null;
    ...
    /**
     * Helper: Generate NIK untuk pegawai baru jika tidak ada
     */
    private function generateNIK()
    {
        // Format NIK: 16 digit (sesuai standar Indonesia)
        // Format: PPPPDDMMYYNNNN
        // PPPP = kode wilayah (contoh: 3173 untuk Jakarta Selatan)
        // DD = tanggal lahir
        // MM = bulan lahir  
        // YY = tahun lahir
        // NNNN = nomor urut
        
        $kodeWilayah = '3173'; // Contoh kode Jakarta Selatan
        $tanggalLahir = date('dmy'); // Default ke tanggal hari ini
        $nomorUrut = str_pad(rand(1000, 9999), 4, '0', STR_PAD_LEFT);
